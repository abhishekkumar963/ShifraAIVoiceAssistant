 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm Shifra, Your voice assistant created by Abhishek";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello Shifra")) {
      const response = "Hello Sir I'm Shifra, How can i help you";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm Shifra, I'm 2 day old";
      speakText(response);
      setInformation(response);
      return;
    }
